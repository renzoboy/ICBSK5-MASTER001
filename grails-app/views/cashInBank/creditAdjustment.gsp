...
<html>
	...
	<title>Cash in Bank Subsidiary Ledger Credit Transactions</title>
    </head>
    <body>
        <content tag="breadcrumbs">
                <span class="fa fa-chevron-right"></span><a href="${createLink(uri: '/cashInBank')}">Cash in Bank/Due From Bank Subsidiary Ledger</a>
                <span class="fa fa-chevron-right"></span><span class="current">Cash in Bank Subsidiary Ledger Credit Transactions</span>
        </content>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[resource:cashInBankInstance, action:'savecreditAdjustment']" method="PUT" >
                            <fieldset class="form">
                                ...
                                <g:hiddenField name="creditAdjustmentId" id="creditAdjustmentId" value="${params.id}" />
        ...
        <content tag="main-actions">
            <ul>
                <li><g:actionSubmit class="save" id="savecreditAdjustment" name="savecreditAdjustment" action="savecreditAdjustment" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
