...
<html>
	...
	<title>Cash in Bank Subsidiary Ledger Debit Transactions</title>
    </head>
    <body>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[resource:cashInBankInstance, action:'savecibDebit']" method="PUT" >
                            <fieldset class="form">
                                <div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnType', 'has-error')} required">
                                    ...
                                    <div class="col-sm-8"><g:select id="txnType" name="txnType" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(43),icbs.lov.MemoTxnType.read(1))}"   optionKey="id" optionValue="description" required="" value="" onchange="getcode();" class="many-to-one form-control"/>
                                    </div>             
                                </div>
                                ...
                                <g:hiddenField name="cibDebit" id="cibDebit" value="${params.id}" />
        ...
        <content tag="main-actions">
            <ul>
                <li><g:actionSubmit class="save" id="savecibDebit" name="savecibDebit" action="savecibDebit" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
