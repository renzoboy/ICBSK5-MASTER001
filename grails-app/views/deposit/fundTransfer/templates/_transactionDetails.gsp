...
<div class="form-group fieldcontain ${hasErrors(bean: fundTransferInstance, field: 'amt', 'has-error')} required">
    <label class="control-label col-sm-4"for="amt">
            <g:message code="fundTransfer.amt.label" default="Amount" />
            <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8">
        <g:textField name="amt" id="amt" value="${fundTransferInstance?.amt}" class="form-control truncated"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: fundTransferInstance, field: 'txnRef', 'has-error')} required">
    <label class="control-label col-sm-4"for="txnRef">
            <g:message code="fundTransfer.txnRef.label" default="Transaction Reference" />
            <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8">
        <g:textField name="txnRef" id="txnRef" value="${fundTransferInstance?.txnRef}" class="form-control"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: fundTransferInstance, field: 'txnDescription', 'has-error')} required">
    <label class="control-label col-sm-4"for="ref">
            <g:message code="fundTransfer.txnDescription.label" default="Description" />
            <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8">
        <g:textField id="txnDescription" name="txnDescription" value="${fundTransferInstance?.txnDescription}" class="form-control"/>
