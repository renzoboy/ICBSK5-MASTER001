...
<div class="fieldcontain form-group ${hasErrors(bean: depositInstance, field: 'interestRate', 'has-error')} ">
                ...
                <div class="col-sm-8">
                    ...
                    <g:else>
                        <g:hiddenField name="interestRate" value="${fieldValue(bean: depositInstance, field: 'interestRate')?:fieldValue(bean: depositInstance, field: 'depositInterestScheme.interestRate')}"/>
