...
<html>
	...
	<title>Edit Accounts Payable Subsidiary Ledger</title>
        ...
        icbs.Dependencies.Ajax.addLoadEvent(function(){            	
            updateCustomerInfoAjax({customer2:"${accountsPayableInstance?.customer?.id}"});	
        });
	...
	<content tag="main-content">
		...
		<g:form id="update" url="[controller:'accountsPayable',action:'updateAccountsPayable']" method="POST" onsubmit="callLoadingDialog();">
                    <fieldset class="form">
