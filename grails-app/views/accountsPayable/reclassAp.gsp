...
<html>
	...
	<title>Reclass Accounts Payable Subsidiary Ledger</title>
        <g:javascript>
	...
	<content tag="main-content">
		...
		<g:form id="create" url="[controller:'AccountsPayable', action:'apSaveReclass']" onsubmit="callLoadingDialog();" method="POST">
                    <g:hiddenField name="accountsPayableId" id="accountsPayableId" value="${accountsPayableInstance?.id}" />
                    <div class="fieldcontain form-group ${hasErrors(bean: accountsPayableInstance, field: 'glContra', 'has-error')} required">
                        ...
                        <div class="col-sm-8"><g:textField name="glContra" id="glContra" maxlength="25" required="" value="${accountsPayableInstance?.glContra}" onblur="validateGlCode();" class="form-control" readonly="true"/>
                    ...
                    <div class="fieldcontain form-group ${hasErrors(bean: accountsPayableInstance, field: 'glContra', 'has-error')} required">
                        ...
                        <div class="col-sm-8"><g:textField name="reclassGlContra" id="reclassGlContra"  required="" value="" onblur="reclassValidateGlCode();" class="form-control" />
                            <g:hasErrors bean="${accountsPayableInstance}" field="reclassGlContra">
                                <div class="controls">
                                    <span class="help-block">
                                        <g:eachError bean="${accountsPayableInstance}" field="reclassGlContra">
                                            <g:message error="${it}" /><br/>
                                        </g:eachError>
                                    </span>
                                </div>
