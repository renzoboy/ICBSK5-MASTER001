...
<html>
	...
	<body>
		...
		<div id="edit-rollover" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:rolloverInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${rolloverInstance?.version}" />
				<fieldset class="form">
