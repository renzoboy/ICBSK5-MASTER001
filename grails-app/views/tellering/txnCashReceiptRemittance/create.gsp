...
<html>
    ...
    <body>
        <content tag="breadcrumbs">
            <span class="fa fa-chevron-right"></span><span class="current">Other Cash Receipt Transaction - Remittance</span>
        </content>
...
<!--            <div id= "addCustomerRelatedError" class="box-body">
            ...
            <g:form name="txnCashReceiptRemittanceForm" action="saveTellerOtherCashReceiptRemittanceTxn" controller="tellering" onsubmit="callLoadingDialog();" >
