...
<html>
    ...
    <body>
        <content tag="breadcrumbs">
            <span class="fa fa-chevron-right"></span><span class="current">Teller Cash Balancing</span>
        </content>
        <content tag="main-content"><g:hasErrors bean="${txnCashFromVaultInstance}">
            ...
            <g:form id ="tellerbBalancingForm" name="tellerbBalancingForm" action="comfirmTellerBalance" controller="tellering" onsubmit="callLoadingDialog();">
