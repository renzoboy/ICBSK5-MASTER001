...
<html>
	<head>
		...
		<title>Create Loan Deduction Scheme</title>
		<g:javascript>    	
	...
	<body>
            <content tag="breadcrumbs">
                ...
                <span class="fa fa-chevron-right"></span><span class="current">Create Loan Deduction Scheme</span>
            </content>
		...
		<div class="content scaffold-create" role="main">
            ...
            <g:form id="create" url="[resource:loanDeductionSchemeInstance, action:'save']" >
		...
		<content tag="main-actions">
      		<ul>
                    ...
                    <li><g:submitButton name="create" id="newLoanDeductionScheme" class="btn btn-primary" value="${message(code: 'default.button.create.label', default: 'Create')}" onclick="
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        $( "#newLoanDeductionScheme" ).click(function() {
                                 checkIfAllowed('CFG01302', 'form#create', 'Override new Check Deposit Clearing Type.', null); // params: policyTemplate.code, form to be saved
                        });
                    }); 
                </script>
                -->
