...
<html>
    <head>
        ...
        <title>Loan Loss Provision Transfer Debit</title>
    </head>
    <body>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[controller:loan, action:'loanAllowanceTransferDebittransaction']" method="PUT" >
                            <fieldset class="form">
                                <div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnType', 'has-error')} required">
                                    ...
                                    <div class="col-sm-8"><g:select id="txnType" name="txnType" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(60),icbs.lov.MemoTxnType.read(1))}" optionKey="id" optionValue="description" required="" value="" onchange="getcode();" class="many-to-one form-control"/>
                                    </div>             
                                </div>
                                ...
                                <div class="fieldcontain form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <g:field class="form-control truncated" id="AllowdebitAmt" name="AllowdebitAmt" value="" />
                                    </div>             
                                </div>
                                <g:hiddenField name="allowDebit" id="allowDebit" value="${params.id}" />
        ...
        <content tag="main-actions">
            <ul>   
                <li><g:submitButton id="loanAllowanceTransferDebittransaction" name="loanAllowanceTransferDebittransaction" value="loanAllowanceTransferDebittransaction" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
