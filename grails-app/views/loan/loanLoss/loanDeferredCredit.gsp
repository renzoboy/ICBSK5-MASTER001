...
<html>
    <head>
        ...
        <title>Loan Deferred Credit Transaction</title>
    </head>
    <body>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[controller:loan, action:'deferredCredit']" method="PUT" >
                            <fieldset class="form">
                                <div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnType', 'has-error')} required">
                                    ...
                                    <div class="col-sm-8"><g:select id="txnType" name="txnType" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(64),icbs.lov.MemoTxnType.read(1))}" optionKey="id" optionValue="description" required="" value="" onchange="getcode();" class="many-to-one form-control"/>
                                    </div>             
                                </div>
                                ...
                                <g:hiddenField name="deferredCreditId" id="deferredCreditId" value="${params.id}" />
