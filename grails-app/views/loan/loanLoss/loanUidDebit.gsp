...
<html>
    <head>
        ...
        <title>Loan UID Debit Transaction</title>
    </head>
    <body>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[controller:loan, action:'saveUidDebit']" method="PUT" >
                            <fieldset class="form">
                                <div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnType', 'has-error')} required">
                                    ...
                                    <div class="col-sm-8"><g:select id="txnType" name="txnType" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(58),icbs.lov.MemoTxnType.read(1))}" optionKey="id" optionValue="description" required="" value="" onchange="getcode();" class="many-to-one form-control"/>
                                    </div>             
                                </div>
                                ...
                                <g:hiddenField name="uidDebit" id="uidDebit" value="${params.id}" />
                                <g:hiddenField name="ididid" id="ididid" value="${params.id}" />
        ...
        <content tag="main-actions">
            <ul>   
                <li><g:submitButton id="saveUidDebit" name="saveUidDebit" value="saveUidDebit" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
