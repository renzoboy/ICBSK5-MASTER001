...
<html>
    <head>
        ...
        <title>Loan Loss Provision Transfer Credit</title>
    </head>
    <body>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[controller:loan, action:'loanAllowanceTransferCredittransaction']" method="PUT" >
                            <fieldset class="form">
                                <div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnType', 'has-error')} required">
                                    ...
                                    <div class="col-sm-8"><g:select id="txnType" name="txnType" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(61),icbs.lov.MemoTxnType.read(1))}" optionKey="id" optionValue="description" required="" value="" onchange="getcode();" class="many-to-one form-control"/>
                                    </div>             
                                </div>
                                <g:hiddenField name="Transfer_Allowance" id="Transfer_Allowance" value="Transfer_Allowance(2)" />
                                <div class="fieldcontain form-group">
                                    <label class="control-label col-sm-4" for="intRate">Credit Amount<span class="required-indicator">*</span></label>                         
                                    <div class="col-sm-8">
                                        <g:field class="form-control truncated" id="AllowcreditAmt" name="AllowcreditAmt" value="" />
                                    </div>             
                                </div>
                                <g:hiddenField name="alloCredit" id="alloCredit" value="${params.id}" />
        ...
        <content tag="main-actions">
            <ul>   
                <li><g:submitButton id="loanAllowanceTransferCredittransaction" name="loanAllowanceTransferCredittransaction" value="loanAllowanceTransferCredittransaction" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
