...
<html>
	<head>
		...
		<g:if test="${module == 'loanRenewal'}">
        	<title>Renew Account ${loanInstance?.accountNo} (${loanInstance?.customer?.displayName}) </title>
        </g:if>
	...
	<body>
        <content tag="breadcrumbs">
            <span class="fa fa-chevron-right"></span><span class="current">Renew Account</span>
	</content>
        ...
        <content tag="main-actions">
            <ul>
                <li><g:submitButton name="save" value="Save" onclick="   
                    ...
                    " /></li>
                <li><g:link controller="loan" action="index" id="${loanInstance.id}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">Cancel</g:link></li>
            </ul>
        </content>
	</body>
</html>
