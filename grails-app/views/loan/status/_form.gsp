...
<div>
    ...
    <g:form name="update-status-form">
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: loanInstance, field: 'status', 'has-error')} ">
            ...
            <div class="col-sm-8">
                    <g:select id="status" name="status.id" from="${LoanAcctStatus.list().findAll{it.id <= 2 }}" optionKey="id" optionValue="description" value="${loanInstance?.status?.id}" class="form-control"/>
