		...
		<g:if test="${session["sweepAccounts"]}">
			...
			<g:each var="sweepAccounts" in="${session["sweeplist"]}">
				<tr>
					...
					<td><a href="#" class="btn btn-secondary" onclick="showUpdateSweepAccount('${sweepAccounts?.id}*${i}')">Edit</a> 
					<a href="#" class="btn btn-secondary" onclick="deleteSweepAccountAjax('${sweepAccounts?.id}*${i}')">Remove</a>
					</td>
				</tr>
