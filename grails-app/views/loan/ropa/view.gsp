...
<div class="form-group">
    <label class="control-label col-sm-4" for="loan">Transaction Type</label>
    <div class="col-sm-6">
...
<div class="fieldcontain form-group ${hasErrors(bean: loanInstance, field: 'loan', 'has-error')} ">
	...
	<div class="col-sm-7"><g:customDatePicker name="MaturityDate" precision="day" class="form-control" format="MM/dd/yyyy" value="${loanInstance?.maturityDate}"/>
	...
	<div class="col-sm-7"> <g:textField type="number" name="grantedAmount" value="${loanInstance?.grantedAmount}" class="form-control truncated" readonly="true"/>  
	...
	<div class="col-sm-7">
            <g:textField type="number" name="balanceAmount" value="${loanInstance?.balanceAmount}" class="form-control truncated" readonly="true"/>        
	...
	<div class="col-sm-7"><g:textField name="interestBalanceAmount" value="${loanInstance?.interestBalanceAmount}"  class="form-control truncated" readonly="true"/>        
	...
	<div class="col-sm-7"><g:textField name="penaltyBalanceAmount" value="${loanInstance?.penaltyBalanceAmount}" class="form-control truncated" readonly="true"/>        
	...
	<div class="col-sm-7"><g:textField name="serviceChargeBalanceAmount" value="${loanInstance?.serviceChargeBalanceAmount}" class="form-control truncated" readonly="true"/>        
