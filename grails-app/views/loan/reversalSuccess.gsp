	...
	<body>
		...
		<div id="show-loanLedger" class="content scaffold-show" role="main">
                         ...
                         <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="70%">${loanLedgerInstance?.txnFile?.txnType?.description}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="70%">${loanLedgerInstance?.txnFile?.txnRef}</td>
                                </tr>
                                <tr>
                                    <td style="font-weight:bold" width="30%">Transaction Particulars</td>
                                    <td width="70%">${loanLedgerInstance?.txnFile?.txnParticulars}</td>
                                </tr>
                                <tr>
         ...
         <content tag="main-actions">
            <ul>
                <li><g:link action="viewLoanPaymentList" controller="loan" id="${loanLedgerInstance?.loan?.id}">Back to Loan Payment Transaction List</g:link></li>
                <li><g:link action="show" controller="loan" id="${loanLedgerInstance?.loan?.id}">Back to Loan Inquiry</g:link></li>
            </ul>
        </content>
	</body>
</html>
