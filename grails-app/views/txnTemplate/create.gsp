...
<html>
	...
	<body>
            ...
            <span class="fa fa-chevron-right"></span><span class="current">Create Transaction Template Information</span>
	</content>
		...
		<div id="create-txnTemplate" class="content scaffold-create" role="main">
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data){
                                                    ...
                                                    $.each(data, function (_key, _value) {
                                                        ...
                                                        console.log("codeUniversal: "+codeUniversal);
                                                    });
                                                },
                                                error: function(data){
                                            ...
                                            if(codeUniversal==code){
                                                ...
                                                function(){
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json",
                                                        url: "${createLink(controller:'TxnTemplate', action:'saveTxnTemplateAjax')}",
                                                        data: JSON.stringify(obj),
                                                        ...
                                                        alertify.alert(AppTitle,"Txn Template Successfully Created!",
                                                            function(){
            ...
            <content tag="main-actions">
                <ul>
                    ...
                    <li><a href="#" onClick='validateFields();' >Create </a></li>
