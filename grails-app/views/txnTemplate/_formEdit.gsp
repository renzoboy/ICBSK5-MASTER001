...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'amlaCode', 'has-error')} ">
	...
	<div class="col-sm-8"><g:textField name="amlaCode" id="amlaCode" maxlength="10" value="${txnTemplateInstance?.amlaCode}" class="form-control"/>
...
<div id="depcontraid" class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'depcontra', 'has-error')} required">
	...
	<div class="col-sm-8"><g:textField name="depContra" id="depContra" maxlength="100" value="${txnTemplateInstance?.defContraAcct}" onblur="validateGlCode();" class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'validationFormCode', 'has-error')} ">
	<label class="control-label col-sm-4" for="validationFormCode">
        ...
        <%-- <g:textField name="appType" id="appType" value="${txnTemplateInstance?.appType}" class="form-control"/> --%>
	<div class="col-sm-8">
                ...
                <g:textField name="appType" id="appType" value="${txnTemplateInstance?.appType}" disabled="disable" class="form-control"/>
...
<div id="requirePassbookDiv" class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'requirePassbook', 'has-error')} ">
	...
	<div class="col-sm-8"><g:select id="requirePassbook" name="requirePassbook.id" from="${icbs.lov.YesNoNa.findAllWhere(status: true)}" optionKey="id" value="${txnTemplateInstance?.requirePassbook?.id}" class="many-to-one form-control" noSelection="['': '']"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'minAmt', 'has-error')} ">
	...
	<div class="col-sm-8"><g:field readonly="true" name="minAmt" id="minAmt" value="${fieldValue(bean: txnTemplateInstance, field: 'minAmt')}" class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'maxAmt', 'has-error')} ">
	...
	<div class="col-sm-8"><g:field readonly="true" name="maxAmt" id="maxAmt" value="${fieldValue(bean: txnTemplateInstance, field: 'maxAmt')}" class="form-control"/>
...
<g:hiddenField id="systemOnlyttxn" name="systemOnlyttxn" value="${txnTemplateInstance?.systemOnlyTxn}"/>
<g:hiddenField id="codevalidator" name="codevalidator" value="${txnTemplateInstance?.code}"/>
<g:hiddenField id="idtxntemplate" name="idtxntemplate" value="${txnTemplateInstance?.id}"/>
