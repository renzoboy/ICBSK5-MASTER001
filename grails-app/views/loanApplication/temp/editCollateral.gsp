...
<html>
	...
	<body>
		...
		<div id="edit-collateral" class="content scaffold-edit" role="main">
			...
			<g:form url="[controller:loanApplication, action:'updateCollateral']" method="PUT">
            ...
            <content tag="main-actions">
                <ul>
					...
					<li><g:link action="createCollateral" params="[loanApplication:"${loanApplicationInstance?.id}"]"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
                </ul>
            </content>
