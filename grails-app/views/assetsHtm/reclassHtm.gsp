...
<html>
	...
	<title>Reclass Assets Held to Maturity Subsidiary Ledger</title>
        <g:javascript>
            ...
            function validateAssetsHeldToMaturityReclass(){
                ...
                if(currentGlContra == ""){
                    ...
                    alertify.confirm(AppTitle,'Are you sure you want to Reclass This HTM?',
                    function(){
                            checkIfAllowed('ADM00102', 'form#create', 'Reclass HTM', null); 
                        },
                        function(){
                            return;
                    });
    ...
    <body>
        <content tag="breadcrumbs">
            <span class="fa fa-chevron-right"></span><a href="${createLink(uri: '/assetsHtm')}">Assets Held to Maturity Subsidiary Ledger</a>
            <span class="fa fa-chevron-right"></span><span class="current">Reclass Assets Held to Maturity Subsidiary Ledger</span>
        </content>
	<content tag="main-content">
		...
		<g:hasErrors bean="${assetsHeldToMaturityInstance}">
                    <ul class="errors" role="alert">
			<g:eachError bean="${assetsHeldToMaturityInstance}" var="error">
		...
		<g:form id="create" url="[controller:'assetsHtm', action:'htmSaveReclass']" onsubmit="callLoadingDialog();" method="POST">
                    <g:hiddenField name="assestsHeldToMaturityId" id="assestsHeldToMaturityId" value="${assetsHeldToMaturityInstance?.id}" />
                    <div class="fieldcontain form-group ${hasErrors(bean: assetsHeldToMaturityInstance, field: 'glContra', 'has-error')} required">
                        <label class="control-label col-sm-4" for="glContra">AR GL Account Code<span class="required-indicator">*</span></label>
                        <div class="col-sm-8"><g:textField name="glContra" id="glContra" maxlength="25" required="" value="${assetsHeldToMaturityInstance?.glCode}" onblur="validateGlCode();" class="form-control" readonly="true"/>
                            <g:hasErrors bean="${assetsHeldToMaturityInstance}" field="glContra">
                                <div class="controls">
                                    <span class="help-block">
                                        <g:eachError bean="${assetsHeldToMaturityInstance}" field="glContra">
                    ...
                    <div id="glaccountdescription" class="fieldcontain form-group ${hasErrors(bean: assetsHeldToMaturityInstance, field: 'depcontra', 'has-error')} required">
                            ...
                            <div class="col-sm-8"><g:textField readonly="true" name="gldescription" id="gldescription" maxlength="100" value="" onblur="validateGlCode();" class="form-control"/>
                                ...
                                <g:hasErrors bean="${assetsHeldToMaturityInstance}" field="memoTxnType">
                                    <div class="controls">
                                            <span class="help-block">
                                                <g:eachError bean="${assetsHeldToMaturityInstance}" field="memoTxnType">
                                                    <g:message error="${it}" /><br/>
                                                </g:eachError>
                                            </span>
                                    </div>
                    ...
                    <legend>Assets Held To Maturity Reclassification Details</legend>
                    <div class="fieldcontain form-group ${hasErrors(bean: assetsHeldToMaturityInstance, field: 'glContra', 'has-error')} required">
                        ...
                        <div class="col-sm-8"><g:textField name="reclassGlContra" id="reclassGlContra"  required="" value="" onblur="reclassValidateGlCode();" class="form-control" />
                            <g:hasErrors bean="${assetsHeldToMaturityInstance}" field="reclassGlContra">
                                <div class="controls">
                                    <span class="help-block">
                                        <g:eachError bean="${assetsHeldToMaturityInstance}" field="reclassGlContra">
                                            <g:message error="${it}" /><br/>
                                        </g:eachError>
                                    </span>
                                </div>
	...
	<content tag="main-actions">
            <ul>
                <li><button onclick="validateAssetsHeldToMaturityReclass();">Save HTM Reclass</button></li>
