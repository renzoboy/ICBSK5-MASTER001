...
<html>
	<head>
		...
		<title>Create New Resident Type</title>
	</head>
        <body>
            <content tag="breadcrumbs">
                <span class="fa fa-chevron-right"></span><a href="${createLink(uri: '/lovMaintenance')}">List of Values Maintenance</a>
                <span class="fa fa-chevron-right"></span><span class="current">Create New Resident Type</span>
            </content>
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${residentTypeInstance}" var="error">
                        ...
                        <div class="tab-pane active fade in" id="tab_1">
                            <g:form controller="lovMaintenance" action="residentTypeInstanceSave" >
                                ...
                                <g:actionSubmit class="btn btn-primary" action="residentTypeInstanceSave" value="${message(code: 'default.button.created.label', default: 'Save')}" formnovalidate="" onclick="return confirm('${message(code: 'default.button.update.confirm.message', default: 'Are you sure you want to create this resident type?')}');" />
                            </g:form>	
                        </div>
                    </div>
            </content>	
		...
		<ul>
                    <li></li>
                    <li><g:link action="customerResidentTypeIndex">Cancel</g:link></li>
		</ul>
            </content>
	</body>
</html>