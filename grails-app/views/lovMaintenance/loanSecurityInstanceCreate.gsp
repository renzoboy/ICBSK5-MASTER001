...
<html>
	<head>
		...
		<title>Create New Loan Security</title>
	</head>
        <body>
           <content tag="breadcrumbs">
                <span class="fa fa-chevron-right"></span><a href="${createLink(uri: '/lovMaintenance')}">List of Values Maintenance</a>
                <span class="fa fa-chevron-right"></span><span class="current">Create New Loan Security</span>
            </content>
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${loanSecurityInstance}" var="error">
                        ...
                        <div class="tab-pane active fade in" id="tab_1">
                            <g:form controller="lovMaintenance" action="loanSecurityInstanceSave" >
                                ...
                                <g:actionSubmit class="btn btn-primary" action="loanSecurityInstanceSave" value="${message(code: 'default.button.created.label', default: 'Save')}" formnovalidate="" onclick="return confirm('${message(code: 'default.button.update.confirm.message', default: 'Are you sure you want to create this loan security?')}');" />
                            </g:form>	
                        </div>
                    </div>
            </content>	
