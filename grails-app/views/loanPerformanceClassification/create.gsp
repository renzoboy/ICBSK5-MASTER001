...
<html>
	<head>
		...
		<title>Create Loan Performance Classification</title>
		<g:javascript>    	
	...
	<body>
            <content tag="breadcrumbs">
                ...
                <span class="fa fa-chevron-right"></span><span class="current">Create Loan Performance Classification</span>
            </content>
		...
		<div class="content scaffold-create" role="main">
			...
			<g:form id="form" url="[controller:loanPerformanceClassification, action:'save']" >
