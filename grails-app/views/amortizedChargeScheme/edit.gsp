...
<html>
	<head>
		...
		<title>Update Amortized Charge Scheme</title>
		<g:javascript>    	
	...
	<body>
            <content tag="breadcrumbs">
                ...
                <span class="fa fa-chevron-right"></span><span class="current">Edit Amortized Charge Scheme</span>
            </content>
		...
		<div class="content scaffold-create" role="main">
			...
			<g:form id="edit" url="[resource:amortizedChargeSchemeInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${amortizedChargeSchemeInstance?.version}" />
		...
		<content tag="main-actions">
      		<ul>
                    ...
                    <li><g:submitButton name="edit" id="editAmortChargeScheme" class="btn btn-primary" value="${message(code: 'default.button.update.label', default: 'Update')}" onclick="
                        ...
                        "/></li>
                    <li><g:link action="show" id="${amortizedChargeSchemeInstance.id}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">Cancel</g:link></li>
	       	</ul>
                <!--    
                <script type="text/javascript">
                    $(document).ready(function() {
                        $( "#editAmortChargeScheme" ).click(function() {
                                 checkIfAllowed('CFG01203', 'form#edit', 'Override new Check Deposit Clearing Type.', null); // params: policyTemplate.code, form to be saved
                        });
                    }); 
                </script>  
                -->
