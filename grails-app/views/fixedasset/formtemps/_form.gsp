...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'glacc', 'has-error')} required">
    ...
    <div class="col-sm-8"><g:select id="glacc" name="glacc.id" from="${icbs.gl.GlAccount.list(max: 100)}" optionKey="code" optionValue="name" required="" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'creditglacc', 'has-error')} required">
    ...
    <div class="col-sm-8"><g:select id="creditglacc" name="creditglacc.id" from="${icbs.gl.GlAccount.list(max: 100)}" optionKey="code" optionValue="name" required="" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'ebitglacc', 'has-error')} required">
    <label class="control-label col-sm-4" for="ebitglacc">
        <g:message code="bankasset.ebitglacc.label" default="Debit Account" />
        <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8"><g:select id="ebitglacc" name="ebitglacc.id" from="${icbs.gl.GlAccount.list(max: 100)}" optionKey="code" optionValue="name" required="" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'vendorlink', 'has-error')} required">
    ...
    <div class="col-sm-8"><g:select id="vendorlink" name="vendorlink" from="${accounting.fixedasset.Vendor.list(max: 100)}" optionKey="companyname" optionValue="companyname" required=""  class="many-to-one form-control"/>
