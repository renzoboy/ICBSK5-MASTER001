...
createTagBody(3, {->
printHtmlPart(10)
invokeTag('message','g',21,['code':("inwardCheckClearing.file.label"),'default':("Loan Collection Mixed Batch File Name")],-1)
printHtmlPart(11)
})
invokeTag('form','g',27,['name':("loanCollMixedBatchForm"),'action':("loanCollMixedBatchProcess"),'controller':("Export"),'enctype':("multipart/form-data")],3)
printHtmlPart(12)
})
