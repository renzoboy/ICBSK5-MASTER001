...
class gsp_icbs_deposit_memo_form_remittance_credit_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/deposit/memo/form/remittance/credit/_form.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('hiddenField','g',11,['id':("acct"),'name':("acct.id"),'value':(remittanceInstance?.acct?.id?:depositInstance?.id)],-1)
printHtmlPart(3)
...
printHtmlPart(5)
invokeTag('select','g',17,['id':("type"),'name':("type.id"),'onchange':("changeMemoForm('remittance')"),'from':(icbs.lov.MemoType.findAllByStatus(true)),'optionKey':("id"),'optionValue':("description"),'value':("2"),'class':("form-control")],-1)
printHtmlPart(6)
createTagBody(1, {->
printHtmlPart(7)
createTagBody(2, {->
...
printHtmlPart(5)
invokeTag('select','g',34,['id':("txnTemplate"),'name':("txnTemplate.id"),'from':(icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(9),icbs.lov.MemoTxnType.read(2),[sort:"code", order:"asc"])),'optionKey':("id"),'optionValue':("description"),'value':(adjustmentInstance?.txnTemplate?.id),'class':("form-control")],-1)
printHtmlPart(6)
createTagBody(1, {->
printHtmlPart(7)
createTagBody(2, {->
...
printHtmlPart(14)
invokeTag('textField','g',51,['id':("RemitCreditAmt"),'name':("amt"),'value':(remittanceInstance?.amt),'class':("form-control truncated")],-1)
printHtmlPart(6)
createTagBody(1, {->
printHtmlPart(7)
createTagBody(2, {->
...
printHtmlPart(16)
invokeTag('textField','g',68,['id':("RemitCreditRef"),'name':("txnRef"),'value':(remittanceInstance?.txnRef),'class':("form-control")],-1)
printHtmlPart(6)
createTagBody(1, {->
printHtmlPart(7)
createTagBody(2, {->
...
printHtmlPart(18)
invokeTag('render','g',108,['template':("/customer/details/customerDetails"),'model':([boxName:'Sender'])],-1)
printHtmlPart(19)
invokeTag('submitButton','g',112,['name':("submit"),'class':("btn btn-primary"),'id':("submitFrmRemit"),'style':("display:none")],-1)
printHtmlPart(20)
