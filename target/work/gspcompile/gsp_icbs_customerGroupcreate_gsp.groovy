...
invokeTag('eachError','g',21,['bean':(customerGroupInstance),'var':("error")],4)
printHtmlPart(16)
})
invokeTag('hasErrors','g',23,['bean':(customerGroupInstance)],3)
printHtmlPart(7)
createTagBody(3, {->
printHtmlPart(17)
...
invokeTag('form','g',28,['id':("create"),'url':([resource:customerGroupInstance, action:'save'])],3)
printHtmlPart(1)
})
...
createTagBody(2, {->
printHtmlPart(19)
invokeTag('submitButton','g',40,['name':("create"),'id':("newCustomerGroup"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
printHtmlPart(20)
createTagBody(3, {->
invokeTag('message','g',41,['code':("default.cancel.label"),'args':([entityName]),'default':("Cancel")],-1)
})
invokeTag('link','g',41,['action':("index")],3)
printHtmlPart(21)
})
