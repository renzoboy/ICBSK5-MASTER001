...
invokeTag('eachError','g',22,['bean':(txnTemplateInstance),'var':("error")],4)
printHtmlPart(16)
})
invokeTag('hasErrors','g',24,['bean':(txnTemplateInstance)],3)
printHtmlPart(9)
createTagBody(3, {->
printHtmlPart(17)
...
invokeTag('javascript','g',387,[:],4)
printHtmlPart(24)
})
invokeTag('form','g',388,['url':([resource:txnTemplateInstance, action:'save']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(25)
})
invokeTag('captureContent','sitemesh',390,['tag':("main-content")],2)
printHtmlPart(3)
createTagBody(2, {->
printHtmlPart(26)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(27)
invokeTag('message','g',393,['code':("default.home.label")],-1)
printHtmlPart(28)
createTagBody(3, {->
invokeTag('message','g',395,['code':("default.list.label"),'args':([entityName])],-1)
})
invokeTag('link','g',395,['class':("list"),'action':("index")],3)
printHtmlPart(29)
})
invokeTag('captureContent','sitemesh',397,['tag':("main-actions")],2)
printHtmlPart(2)
})
