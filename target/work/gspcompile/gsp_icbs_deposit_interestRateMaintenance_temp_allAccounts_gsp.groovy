...
class gsp_icbs_deposit_interestRateMaintenance_temp_allAccounts_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/deposit/interestRateMaintenance/temp/_allAccounts.gsp" }
public Object run() {
Writer out = getOut()
