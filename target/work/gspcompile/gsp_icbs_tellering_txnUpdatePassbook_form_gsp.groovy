...
class gsp_icbs_tellering_txnUpdatePassbook_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/tellering/txnUpdatePassbook/_form.gsp" }
public Object run() {
Writer out = getOut()
