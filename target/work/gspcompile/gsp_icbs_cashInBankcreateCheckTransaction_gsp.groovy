...
class gsp_icbs_cashInBankcreateCheckTransaction_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/cashInBank/createCheckTransaction.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(3, {->
printHtmlPart(19)
invokeTag('render','g',27,['template':("cibCheckTransaction")],-1)
printHtmlPart(20)
})
invokeTag('form','g',29,['id':("create"),'url':([resource:cashInBankInstance, action:'saveChkTransaction'])],3)
printHtmlPart(21)
})
...
createTagBody(2, {->
printHtmlPart(22)
invokeTag('submitButton','g',42,['id':("newCIB"),'name':("create"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
printHtmlPart(23)
createTagBody(3, {->
invokeTag('message','g',43,['code':("default.cancel.label"),'args':([entityName]),'default':("Cancel")],-1)
})
invokeTag('link','g',43,['action':("index")],3)
printHtmlPart(24)
})
