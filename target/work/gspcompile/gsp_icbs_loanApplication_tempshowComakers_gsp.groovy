...
class gsp_icbs_loanApplication_tempshowComakers_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loanApplication/temp/showComakers.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('render','g',43,['template':("showComakers")],-1)
printHtmlPart(13)
createTagBody(3, {->
printHtmlPart(14)
