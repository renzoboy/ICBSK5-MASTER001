...
class gsp_icbs_collateralManagement_attachments_edit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/collateralManagement/attachments/_edit.gsp" }
public Object run() {
Writer out = getOut()
