...
printHtmlPart(15)
invokeTag('sortableColumn','g',46,['property':("code"),'title':(message(code: 'amortizedChargeScheme.code.label', default: 'Code'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',48,['property':("name"),'title':(message(code: 'amortizedChargeScheme.name.label', default: 'Name'))],-1)
printHtmlPart(17)
invokeTag('sortableColumn','g',50,['property':("name"),'title':(message(code: 'amortizedChargeScheme.basis.label', default: 'Basis'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',52,['property':("status"),'title':(message(code: 'amortizedChargeScheme.status.label', default: 'Status'))],-1)
printHtmlPart(18)
loop:{
int i = 0
...
invokeTag('link','g',67,['class':("btn btn-secondary"),'action':("show"),'id':(amortizedChargeSchemeInstance.id)],4)
printHtmlPart(25)
i++
}
}
printHtmlPart(26)
invokeTag('paginate','g',74,['total':(amortizedChargeSchemeInstanceCount ?: 0)],-1)
printHtmlPart(27)
})
