...
class gsp_icbs_accountsPayablereclassAp_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/accountsPayable/reclassAp.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',147,['bean':(accountsPayableInstance),'var':("error")],4)
printHtmlPart(20)
})
invokeTag('hasErrors','g',149,['bean':(accountsPayableInstance)],3)
printHtmlPart(13)
createTagBody(3, {->
printHtmlPart(21)
invokeTag('hiddenField','g',151,['name':("accountsPayableId"),'id':("accountsPayableId"),'value':(accountsPayableInstance?.id)],-1)
printHtmlPart(22)
expressionOut.print(hasErrors(bean: accountsPayableInstance, field: 'glContra', 'has-error'))
printHtmlPart(23)
invokeTag('textField','g',154,['name':("glContra"),'id':("glContra"),'maxlength':("25"),'required':(""),'value':(accountsPayableInstance?.glContra),'onblur':("validateGlCode();"),'class':("form-control"),'readonly':("true")],-1)
printHtmlPart(24)
createTagBody(4, {->
printHtmlPart(25)
createTagBody(5, {->
...
invokeTag('eachError','g',160,['bean':(accountsPayableInstance),'field':("glContra")],5)
printHtmlPart(28)
})
invokeTag('hasErrors','g',163,['bean':(accountsPayableInstance),'field':("glContra")],4)
printHtmlPart(29)
...
printHtmlPart(31)
invokeTag('textField','g',172,['readonly':("true"),'name':("gldescription"),'id':("gldescription"),'maxlength':("100"),'value':(txnTemplateInstance?.amlaCode),'onblur':("validateGlCode();"),'class':("form-control")],-1)
printHtmlPart(32)
createTagBody(4, {->
printHtmlPart(33)
createTagBody(5, {->
...
invokeTag('eachError','g',179,['bean':(txnTemplateInstance),'field':("memoTxnType")],5)
printHtmlPart(36)
})
invokeTag('hasErrors','g',182,['bean':(txnTemplateInstance),'field':("memoTxnType")],4)
printHtmlPart(37)
expressionOut.print(hasErrors(bean: accountsPayableInstance, field: 'glContra', 'has-error'))
printHtmlPart(38)
...
invokeTag('eachError','g',196,['bean':(accountsPayableInstance),'field':("reclassGlContra")],5)
printHtmlPart(28)
})
invokeTag('hasErrors','g',199,['bean':(accountsPayableInstance),'field':("reclassGlContra")],4)
printHtmlPart(39)
expressionOut.print(hasErrors(bean: txnTemplateInstance, field: 'depcontra', 'has-error'))
printHtmlPart(30)
...
invokeTag('form','g',221,['id':("create"),'url':([controller:'AccountsPayable', action:'apSaveReclass']),'onsubmit':("callLoadingDialog();"),'method':("POST")],3)
printHtmlPart(41)
})
