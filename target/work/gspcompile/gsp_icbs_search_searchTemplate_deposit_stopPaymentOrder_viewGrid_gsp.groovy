...
class gsp_icbs_search_searchTemplate_deposit_stopPaymentOrder_viewGrid_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/search/searchTemplate/deposit/stopPaymentOrder/_viewGrid.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
invokeTag('hiddenField','g',16,['id':("searchDomain"),'name':("searchDomain"),'value':("deposit-stopPaymentOrder")],-1)
printHtmlPart(6)
...
printHtmlPart(12)
expressionOut.print(domainInstance?.cheque?.chequeNo)
printHtmlPart(13)
expressionOut.print(domainInstance?.stopBy?.username)
printHtmlPart(13)
expressionOut.print(domainInstance?.stopAt?.format("MM/dd/yyyy"))
printHtmlPart(13)
