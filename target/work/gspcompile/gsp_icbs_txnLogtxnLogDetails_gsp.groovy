...
printHtmlPart(24)
invokeTag('formatNumber','g',99,['number':(gl.debitAmt),'format':("###,###,##0.00")],-1)
printHtmlPart(25)
...
printHtmlPart(26)
invokeTag('formatNumber','g',105,['number':(gl.creditAmt),'format':("###,###,##0.00")],-1)
printHtmlPart(27)
i++
}
}
...
invokeTag('link','g',116,['action':("viewTellerBalancing"),'id':(txnFileInstance.id)],3)
printHtmlPart(34)
})
