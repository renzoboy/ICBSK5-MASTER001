...
printHtmlPart(13)
invokeTag('render','g',65,['template':("loanApplication/show")],-1)
printHtmlPart(14)
invokeTag('render','g',68,['template':("specification/showHistory")],-1)
printHtmlPart(15)
invokeTag('render','g',71,['template':("classification/showHistory")],-1)
printHtmlPart(16)
invokeTag('render','g',74,['template':("serviceCharges/show")],-1)
printHtmlPart(17)
invokeTag('render','g',77,['template':("deductions/show")],-1)
printHtmlPart(18)
invokeTag('render','g',80,['template':("advancedInterests/list")],-1)
printHtmlPart(19)
invokeTag('render','g',83,['template':("installments/schedule")],-1)
printHtmlPart(20)
invokeTag('render','g',86,['template':("sweep/show")],-1)
printHtmlPart(21)
})
...
invokeTag('link','g',93,['action':("show"),'id':(origLoanInstance?.id)],3)
printHtmlPart(24)
})
