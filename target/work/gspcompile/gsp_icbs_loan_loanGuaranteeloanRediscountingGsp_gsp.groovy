...
class gsp_icbs_loan_loanGuaranteeloanRediscountingGsp_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/loanGuarantee/loanRediscountingGsp.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
invokeTag('render','g',47,['template':("/loan/loanGuarantee/form/loanRediscount")],-1)
printHtmlPart(15)
})
invokeTag('form','g',50,['id':("loan-form"),'url':([controller:loan, action:'saveLoanRediscounting']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(16)
})
...
createTagBody(2, {->
printHtmlPart(17)
invokeTag('submitButton','g',63,['id':("save"),'name':("save"),'value':("Save"),'onclick':("""
...
invokeTag('link','g',66,['class':("list"),'action':("loanGurantee"),'id':(loanInstance.id)],3)
printHtmlPart(20)
})
