...
class gsp_icbs_fsControlAccountedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fsControlAccount/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('javascript','g',92,[:],4)
printHtmlPart(7)
})
invokeTag('form','g',93,['id':("create"),'url':([controller:'fsControlAccount', action:'saveEdit']),'onsubmit':("callLoadingDialog();"),'method':("POST")],3)
printHtmlPart(19)
})
...
printHtmlPart(20)
createTagBody(3, {->
invokeTag('message','g',99,['code':("default.cancel.label"),'args':([entityName]),'default':("Cancel")],-1)
})
invokeTag('link','g',99,['action':("index")],3)
printHtmlPart(21)
})
