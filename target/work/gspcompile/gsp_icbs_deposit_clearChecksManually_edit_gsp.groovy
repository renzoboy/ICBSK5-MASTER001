...
class gsp_icbs_deposit_clearChecksManually_edit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/deposit/clearChecksManually/_edit.gsp" }
public Object run() {
Writer out = getOut()
