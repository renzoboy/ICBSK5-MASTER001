...
class gsp_icbs_loan_loanLossloanDeferredDebit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/loanLoss/loanDeferredDebit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
invokeTag('select','g',56,['id':("txnType"),'name':("txnType"),'from':(icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(65),icbs.lov.MemoTxnType.read(1))),'optionKey':("id"),'optionValue':("description"),'required':(""),'value':(""),'onchange':("getcode();"),'class':("many-to-one form-control")],-1)
printHtmlPart(15)
invokeTag('field','g',62,['class':("form-control truncated"),'id':("debitAmt"),'name':("debitAmt"),'value':("")],-1)
printHtmlPart(16)
invokeTag('hiddenField','g',65,['name':("deferredDebitId"),'id':("deferredDebitId"),'value':(params.id)],-1)
printHtmlPart(17)
...
invokeTag('form','g',80,['id':("deposit"),'url':([controller:loan, action:'deferredDebit']),'method':("PUT")],3)
printHtmlPart(20)
})
...
createTagBody(2, {->
printHtmlPart(22)
invokeTag('submitButton','g',94,['id':("saveUidCredit"),'name':("saveUidCredit"),'value':(message(code: 'default.button.Save.label', default: 'Save')),'onclick':("""
                        alertify.confirm(AppTitle,'Are you sure you want to continue this transaction?',
                                function(){
                                     checkIfAllowed('CFG00303', 'form#deposit', 'Override edit Deferred Debit.', null); 
                                },
                                function(){
                                    return;
                                });     
