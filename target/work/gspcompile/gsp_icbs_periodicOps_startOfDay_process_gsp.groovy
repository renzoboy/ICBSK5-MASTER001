...
class gsp_icbs_periodicOps_startOfDay_process_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/periodicOps/startOfDay/_process.gsp" }
public Object run() {
Writer out = getOut()
