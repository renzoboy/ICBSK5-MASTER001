...
class gsp_icbs_deposit_fundTransfer_templates_creditAccount_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/deposit/fundTransfer/templates/_creditAccount.gsp" }
public Object run() {
Writer out = getOut()
