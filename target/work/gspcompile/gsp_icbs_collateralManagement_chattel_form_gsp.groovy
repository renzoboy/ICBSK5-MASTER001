...
class gsp_icbs_collateralManagement_chattel_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/collateralManagement/chattel/_form.gsp" }
public Object run() {
Writer out = getOut()
