...
printHtmlPart(10)
invokeTag('select','g',27,['id':("txnType"),'name':("txnType"),'from':(icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(44),icbs.lov.MemoTxnType.read(1))),'optionKey':("id"),'optionValue':("description"),'required':(""),'value':(""),'onchange':("getcode();"),'class':("many-to-one form-control")],-1)
printHtmlPart(11)
invokeTag('field','g',33,['class':("form-control truncated"),'id':("creditAmt"),'name':("creditAmt"),'value':("")],-1)
printHtmlPart(12)
invokeTag('hiddenField','g',36,['name':("creditAdjustmentId"),'id':("creditAdjustmentId"),'value':(params.id)],-1)
printHtmlPart(13)
...
invokeTag('form','g',51,['id':("deposit"),'url':([resource:cashInBankInstance, action:'savecreditAdjustment']),'method':("PUT")],3)
printHtmlPart(16)
})
...
createTagBody(2, {->
printHtmlPart(18)
invokeTag('actionSubmit','g',66,['class':("save"),'id':("savecreditAdjustment"),'name':("savecreditAdjustment"),'action':("savecreditAdjustment"),'value':(message(code: 'default.button.Save.label', default: 'Save')),'onclick':("""
