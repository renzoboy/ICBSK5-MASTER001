...
printHtmlPart(30)
invokeTag('formatDate','g',109,['date':(ctd?.issueCTD?.dateIssued),'type':("date"),'style':("LONG")],-1)
printHtmlPart(30)
expressionOut.print(ctd?.status?.description)
printHtmlPart(31)
}
printHtmlPart(32)
invokeTag('paginate','g',115,['total':(ctdInstanceCount ?: 0),'params':(params)],-1)
printHtmlPart(33)
})
...
invokeTag('link','g',125,['action':("show"),'id':(docInventoryInstance.id)],3)
printHtmlPart(41)
})
