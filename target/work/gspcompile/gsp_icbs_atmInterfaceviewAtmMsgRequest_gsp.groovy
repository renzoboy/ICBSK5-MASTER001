...
createTagBody(2, {->
printHtmlPart(7)
for( branchInstance in (AtmMsgRequest) ) {
printHtmlPart(8)
...
printHtmlPart(10)
invokeTag('message','g',30,['code':("atmTerminalInstance.branch.label"),'default':("Date Received")],-1)
printHtmlPart(9)
expressionOut.print(fieldValue(bean: branchInstance, field: "dateReceived"))
printHtmlPart(11)
invokeTag('message','g',34,['code':("atmTerminalInstance.branch.label"),'default':("Message Content")],-1)
printHtmlPart(12)
expressionOut.print(fieldValue(bean: branchInstance, field: "msgContent"))
printHtmlPart(13)
invokeTag('message','g',38,['code':("atmTerminalInstance.branch.label"),'default':("Message Length")],-1)
printHtmlPart(9)
expressionOut.print(fieldValue(bean: branchInstance, field: "msgLength"))
printHtmlPart(14)
invokeTag('message','g',42,['code':("atmTerminalInstance.branch.label"),'default':("source Ip:")],-1)
printHtmlPart(9)
expressionOut.print(fieldValue(bean: branchInstance, field: "sourceIp"))
printHtmlPart(15)
}
printHtmlPart(16)
})
