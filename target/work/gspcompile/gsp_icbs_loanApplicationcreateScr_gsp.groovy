...
class gsp_icbs_loanApplicationcreateScr_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loanApplication/createScr.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(3, {->
printHtmlPart(32)
invokeTag('render','g',309,['template':("specification/formScr")],-1)
printHtmlPart(33)
...
invokeTag('form','g',321,['id':("loan-application-form"),'url':([resource:loanApplicationInstance, action:'saveScr']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(37)
})
