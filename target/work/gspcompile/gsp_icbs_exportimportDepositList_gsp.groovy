...
createTagBody(3, {->
printHtmlPart(10)
invokeTag('message','g',21,['code':("inwardCheckClearing.file.label"),'default':("Deposit Batch Transactions File Name")],-1)
printHtmlPart(11)
})
invokeTag('form','g',27,['name':("loanCollForm"),'action':("processImportDeposit"),'controller':("Export"),'enctype':("multipart/form-data")],3)
printHtmlPart(12)
})
