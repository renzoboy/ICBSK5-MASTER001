...
class gsp_icbs_configLogindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/configLog/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(19)
invokeTag('sortableColumn','g',40,['property':("description"),'title':(message(code: 'auditLog.description.label', default: 'Description'))],-1)
printHtmlPart(20)
...
printHtmlPart(27)
expressionOut.print(fieldValue(bean: auditLogInstance, field: "description"))
printHtmlPart(28)
...
printHtmlPart(30)
invokeTag('paginate','g',66,['total':(AuditLogInstanceCount ?: 0),'params':(params)],-1)
printHtmlPart(31)
})
