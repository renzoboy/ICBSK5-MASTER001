...
class gsp_icbs_loan_ropa_templates_creditAccount_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/ropa/templates/_creditAccount.gsp" }
public Object run() {
Writer out = getOut()
