...
class gsp_icbs_rollovercreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/rollover/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'rollover.label', default: 'Rollover'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',18,['bean':(rolloverInstance),'var':("error")],4)
printHtmlPart(14)
})
invokeTag('hasErrors','g',20,['bean':(rolloverInstance)],3)
printHtmlPart(7)
createTagBody(3, {->
printHtmlPart(15)
...
invokeTag('form','g',28,['url':([resource:rolloverInstance, action:'save'])],3)
printHtmlPart(18)
})
