...
class gsp_icbs_loan_reschedule_sweep_list_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/reschedule/sweep/_list.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
invokeTag('hiddenField','g',64,['name':("sweepAccountId"),'value':("")],-1)
printHtmlPart(10)
}
