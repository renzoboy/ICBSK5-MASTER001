...
printHtmlPart(3)
invokeTag('select','g',41,['id':("txnTemplates"),'name':("txnTemplates"),'from':(tmplist),'optionKey':("id"),'optionValue':("description"),'value':(productInstance?.txnTemplates?.id),'class':("many-to-one form-control")],-1)
printHtmlPart(4)
}
printHtmlPart(5)
}
