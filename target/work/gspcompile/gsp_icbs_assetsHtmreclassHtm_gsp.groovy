...
class gsp_icbs_assetsHtmreclassHtm_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/assetsHtm/reclassHtm.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',147,['bean':(assetsHeldToMaturityInstance),'var':("error")],4)
printHtmlPart(20)
})
invokeTag('hasErrors','g',149,['bean':(assetsHeldToMaturityInstance)],3)
printHtmlPart(13)
createTagBody(3, {->
printHtmlPart(21)
invokeTag('hiddenField','g',151,['name':("assestsHeldToMaturityId"),'id':("assestsHeldToMaturityId"),'value':(assetsHeldToMaturityInstance?.id)],-1)
printHtmlPart(22)
expressionOut.print(hasErrors(bean: assetsHeldToMaturityInstance, field: 'glContra', 'has-error'))
printHtmlPart(23)
invokeTag('textField','g',154,['name':("glContra"),'id':("glContra"),'maxlength':("25"),'required':(""),'value':(assetsHeldToMaturityInstance?.glCode),'onblur':("validateGlCode();"),'class':("form-control"),'readonly':("true")],-1)
printHtmlPart(24)
createTagBody(4, {->
printHtmlPart(25)
createTagBody(5, {->
...
invokeTag('eachError','g',160,['bean':(assetsHeldToMaturityInstance),'field':("glContra")],5)
printHtmlPart(28)
})
invokeTag('hasErrors','g',163,['bean':(assetsHeldToMaturityInstance),'field':("glContra")],4)
printHtmlPart(29)
expressionOut.print(hasErrors(bean: assetsHeldToMaturityInstance, field: 'depcontra', 'has-error'))
printHtmlPart(30)
...
invokeTag('eachError','g',179,['bean':(assetsHeldToMaturityInstance),'field':("memoTxnType")],5)
printHtmlPart(36)
})
invokeTag('hasErrors','g',182,['bean':(assetsHeldToMaturityInstance),'field':("memoTxnType")],4)
printHtmlPart(37)
expressionOut.print(hasErrors(bean: assetsHeldToMaturityInstance, field: 'glContra', 'has-error'))
printHtmlPart(38)
...
invokeTag('eachError','g',196,['bean':(assetsHeldToMaturityInstance),'field':("reclassGlContra")],5)
printHtmlPart(28)
})
invokeTag('hasErrors','g',199,['bean':(assetsHeldToMaturityInstance),'field':("reclassGlContra")],4)
printHtmlPart(39)
...
invokeTag('form','g',221,['id':("create"),'url':([controller:'assetsHtm', action:'htmSaveReclass']),'onsubmit':("callLoadingDialog();"),'method':("POST")],3)
printHtmlPart(41)
})
