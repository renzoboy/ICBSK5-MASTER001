...
class gsp_icbs_transactionBreakdowncreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transactionBreakdown/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'transactionBreakdown.label', default: 'TxnBreakdown'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',18,['bean':(transactionBreakdownInstance),'var':("error")],4)
printHtmlPart(14)
})
invokeTag('hasErrors','g',20,['bean':(transactionBreakdownInstance)],3)
printHtmlPart(7)
createTagBody(3, {->
printHtmlPart(15)
...
invokeTag('form','g',28,['url':([resource:transactionBreakdownInstance, action:'save'])],3)
printHtmlPart(18)
})
