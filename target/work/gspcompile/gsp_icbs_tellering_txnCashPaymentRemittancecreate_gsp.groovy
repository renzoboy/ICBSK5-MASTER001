...
invokeTag('eachError','g',95,['bean':(txnCashPaymentRemittanceInstance),'var':("error")],4)
printHtmlPart(25)
})
invokeTag('hasErrors','g',99,['bean':(txnCashPaymentRemittanceInstance)],3)
printHtmlPart(13)
createTagBody(3, {->
printHtmlPart(26)
invokeTag('render','g',101,['template':("txnCashPaymentRemittance/form"),'model':([txnCashPaymentRemittanceInstance:txnCashPaymentRemittanceInstance])],-1)
printHtmlPart(13)
})
invokeTag('form','g',102,['name':("txnCashPaymentRemittanceForm"),'action':("saveTellerOtherCashPaymentRemittanceTxn"),'controller':("tellering"),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(27)
})
...
invokeTag('link','g',154,['action':("index")],3)
printHtmlPart(33)
})
