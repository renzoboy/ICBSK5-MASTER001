...
printHtmlPart(15)
invokeTag('sortableColumn','g',46,['property':("code"),'title':(message(code: 'loanPerformanceClassification.code.label', default: 'Code'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',48,['property':("name"),'title':(message(code: 'loanPerformanceClassification.name.label', default: 'Name'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',50,['property':("status"),'title':(message(code: 'loanPerformanceClassification.prevClassification.label', default: 'Previous Classification'))],-1)
printHtmlPart(17)
invokeTag('sortableColumn','g',52,['property':("status"),'title':(message(code: 'loanPerformanceClassification.newClassification.label', default: 'New Classification'))],-1)
printHtmlPart(18)
loop:{
int i = 0
...
invokeTag('link','g',68,['class':("btn btn-secondary"),'action':("show"),'id':(loanPerformanceClassificationInstance.id)],4)
printHtmlPart(25)
i++
}
}
printHtmlPart(26)
invokeTag('paginate','g',75,['total':(loanPerformanceClassificationInstanceCount ?: 0)],-1)
printHtmlPart(27)
})
