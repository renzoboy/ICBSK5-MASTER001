...
class gsp_icbs_collateralManagement_attachments_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/collateralManagement/attachments/_form.gsp" }
public Object run() {
Writer out = getOut()
