...
class gsp_icbs_collateralManagement_attachments_show_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/collateralManagement/attachments/_show.gsp" }
public Object run() {
Writer out = getOut()
