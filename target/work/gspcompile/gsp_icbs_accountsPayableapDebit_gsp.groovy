...
printHtmlPart(26)
invokeTag('select','g',93,['id':("txnType"),'name':("txnType"),'from':(icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(49),icbs.lov.MemoTxnType.read(1))),'optionKey':("id"),'optionValue':("description"),'required':(""),'value':(""),'onchange':("getcode();"),'class':("many-to-one form-control")],-1)
printHtmlPart(27)
invokeTag('field','g',99,['class':("form-control truncated"),'id':("debitAmt"),'name':("debitAmt"),'value':("")],-1)
printHtmlPart(28)
invokeTag('hiddenField','g',102,['name':("apDebit"),'id':("apDebit"),'value':(params.id)],-1)
printHtmlPart(29)
invokeTag('hiddenField','g',103,['name':("apExbalance"),'id':("apExbalance"),'value':(accountsPayableInstance.balance)],-1)
printHtmlPart(30)
...
invokeTag('form','g',117,['id':("deposit"),'url':([resource:accountsPayableInstance, action:'saveapDebit']),'method':("PUT"),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(33)
createClosureForHtmlPart(34, 3)
invokeTag('javascript','g',163,[:],3)
printHtmlPart(5)
})
invokeTag('captureContent','sitemesh',164,['tag':("main-content")],2)
printHtmlPart(35)
createTagBody(2, {->
printHtmlPart(36)
createClosureForHtmlPart(37, 3)
invokeTag('link','g',169,['action':("show"),'id':(accountsPayableInstance.id)],3)
printHtmlPart(38)
})
