...
class gsp_icbs_collateralManagement_details_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/collateralManagement/details/_form.gsp" }
public Object run() {
Writer out = getOut()
