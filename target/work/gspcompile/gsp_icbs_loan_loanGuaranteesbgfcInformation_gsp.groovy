...
class gsp_icbs_loan_loanGuaranteesbgfcInformation_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/loanGuarantee/sbgfcInformation.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
invokeTag('render','g',47,['template':("/loan/loanGuarantee/form/smallBusinessGuaranAndFee")],-1)
printHtmlPart(15)
})
invokeTag('form','g',48,['id':("loan-form"),'url':([controller:loan, action:'saveSbgfcInformation']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(16)
})
...
invokeTag('link','g',63,['class':("list"),'action':("loanGurantee"),'id':(loanInstance.id)],3)
printHtmlPart(20)
})
