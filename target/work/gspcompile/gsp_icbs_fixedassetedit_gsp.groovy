...
class gsp_icbs_fixedassetedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fixedasset/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',19,['bean':(bankassetInstance),'var':("error")],4)
printHtmlPart(14)
})
invokeTag('hasErrors','g',21,['bean':(bankassetInstance)],3)
printHtmlPart(7)
createTagBody(3, {->
printHtmlPart(7)
invokeTag('hiddenField','g',23,['name':("version"),'value':(bankassetInstance?.version)],-1)
printHtmlPart(15)
invokeTag('render','g',25,['template':("/fixedasset/formtemps/formedt")],-1)
printHtmlPart(16)
...
invokeTag('form','g',31,['action':("update"),'id':(bankassetInstance.id),'method':("PUT")],3)
printHtmlPart(18)
})
