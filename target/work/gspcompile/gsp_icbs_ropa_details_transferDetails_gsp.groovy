...
class gsp_icbs_ropa_details_transferDetails_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/ropa/details/_transferDetails.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('formatNumber','g',34,['format':("###,###,##0.00"),'number':(collateralInstance?.collateral?.appraisedValue)],-1)
printHtmlPart(8)
}
