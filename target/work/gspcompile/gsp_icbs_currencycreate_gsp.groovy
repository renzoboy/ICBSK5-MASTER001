...
class gsp_icbs_currencycreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/currency/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'currency.label', default: 'Currency'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('form','g',29,['id':("create"),'url':([resource:currencyInstance, action:'save'])],3)
printHtmlPart(18)
})
...
createTagBody(2, {->
printHtmlPart(19)
invokeTag('submitButton','g',43,['id':("newCcy"),'name':("create"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
printHtmlPart(20)
createTagBody(3, {->
invokeTag('message','g',44,['code':("default.cancel.label"),'args':([entityName]),'default':("Cancel")],-1)
})
invokeTag('link','g',44,['action':("index")],3)
printHtmlPart(21)
})
