...
class gsp_icbs_collateralManagement_attachments_list_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/collateralManagement/attachments/_list.gsp" }
public Object run() {
Writer out = getOut()
Writer expressionOut = getExpressionOut()
registerSitemeshPreprocessMode()
printHtmlPart(0)
if(true && (collateralInstance?.attachments)) {
printHtmlPart(1)
for( attachment in (collateralInstance?.attachments.sort{it.fileName}) ) {
printHtmlPart(2)
