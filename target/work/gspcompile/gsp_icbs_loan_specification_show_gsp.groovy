...
class gsp_icbs_loan_specification_show_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/specification/_show.gsp" }
public Object run() {
Writer out = getOut()
