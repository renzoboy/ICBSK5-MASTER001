...
printHtmlPart(10)
invokeTag('sortableColumn','g',38,['property':("code"),'title':(message(code: 'holiday.code.label', default: 'Code'))],-1)
printHtmlPart(11)
invokeTag('sortableColumn','g',40,['property':("description"),'title':(message(code: 'holiday.description.label', default: 'Description'))],-1)
printHtmlPart(11)
invokeTag('sortableColumn','g',41,['property':("date"),'title':(message(code: 'holiday.date.label', default: 'Date'))],-1)
printHtmlPart(11)
invokeTag('sortableColumn','g',45,['property':("type"),'title':(message(code: 'holiday.type.label', default: 'Type'))],-1)
printHtmlPart(12)
invokeTag('sortableColumn','g',51,['property':("status"),'title':(message(code: 'holiday.configItemStatus.label', default: 'Status'))],-1)
printHtmlPart(12)
invokeTag('sortableColumn','g',53,['property':("status"),'title':(message(code: 'holiday.institutionWideHoliday.label', default: 'Bank Wide'))],-1)
printHtmlPart(13)
loop:{
int i = 0
...
invokeTag('link','g',57,['action':("show"),'id':(holidayInstance.id)],4)
printHtmlPart(16)
expressionOut.print(fieldValue(bean: holidayInstance, field: "description"))
printHtmlPart(16)
invokeTag('formatDate','g',59,['format':("MM/dd/yyyy"),'date':(holidayInstance?.holidayDate)],-1)
printHtmlPart(16)
