...
class gsp_icbs_loan_loanGuaranteehgcInformation_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/loanGuarantee/hgcInformation.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
invokeTag('render','g',47,['template':("/loan/loanGuarantee/form/homeGuaranteeCorp")],-1)
printHtmlPart(15)
})
invokeTag('form','g',48,['id':("loan-form"),'url':([controller:loan, action:'saveHgcInformation']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(16)
})
