...
class gsp_icbs_creditInvestigation_attachments_show_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/creditInvestigation/attachments/_show.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',20,['class':("btn btn-secondary"),'action':("showAttachment"),'id':(attachment?.id)],2)
printHtmlPart(4)
