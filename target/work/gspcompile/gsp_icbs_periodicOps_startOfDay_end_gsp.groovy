...
class gsp_icbs_periodicOps_startOfDay_end_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/periodicOps/startOfDay/_end.gsp" }
public Object run() {
Writer out = getOut()
