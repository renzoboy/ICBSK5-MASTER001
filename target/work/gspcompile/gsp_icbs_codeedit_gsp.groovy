...
class gsp_icbs_codeedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/code/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'code.label', default: 'Code'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',19,['bean':(codeInstance),'var':("error")],4)
printHtmlPart(14)
})
invokeTag('hasErrors','g',21,['bean':(codeInstance)],3)
printHtmlPart(7)
createTagBody(3, {->
printHtmlPart(15)
invokeTag('hiddenField','g',23,['name':("version"),'value':(codeInstance?.version)],-1)
printHtmlPart(16)
...
invokeTag('form','g',30,['url':([resource:codeInstance, action:'update']),'method':("PUT")],3)
printHtmlPart(19)
})
