...
class gsp_icbs_tellering_txnReprintPassbookcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/tellering/txnReprintPassbook/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(13)
invokeTag('render','g',30,['template':("txnReprintPassbook/form")],-1)
printHtmlPart(14)
})
