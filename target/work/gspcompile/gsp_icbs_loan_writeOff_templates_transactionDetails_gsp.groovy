...
class gsp_icbs_loan_writeOff_templates_transactionDetails_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loan/writeOff/templates/_transactionDetails.gsp" }
public Object run() {
Writer out = getOut()
